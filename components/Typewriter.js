  ...
  return (
    <div className="h-auto md:h-[55vh] w-full max-w-6xl m-auto p-4 grid grid-cols-1 md:grid-cols-2 items-center gap-6">
      ...
      <div className="flex justify-center items-center">
        <div className="relative w-65 h-65 flex items-center justify-center rounded-full">
          {/* Neon Multi-color Animated Border */}
          <div className="absolute inset-0 rounded-full bg-linear-to-r from-pink-500 via-purple-500 to-blue-500 animate-spin blur-xl opacity-70"></div>
          ...
          <Image
            ...
            src="/Subhan-Crop.jpg"
            alt="Subhan Ramzan"
            className="rounded-full h-auto w-auto bg-linear-to-r from-pink-500 via-purple-500 to-blue-500 z-10"
            priority
          />
        </div>
      </div>
      ...
      <div className="flex flex-col items-start justify-center space-y-3 w-full m-auto">
        ...
        <p className="text-base  text-gray-300 leading-relaxed">
          This website was built from scratch to showcase my web development
          skills. <br />
          Every line of code is written manually without the help of ChatGPT or
        ...
        <div className="flex flex-row items-center gap-3 text-2xl ">
          <Link
            ...
            target="_blank"
            className="hover:bg-blue-900 hover:scale-105 bg-blue-700 p-2 rounded-2xl transition"
          >
            <FaWhatsapp size={30} />
          </Link>
