    ...
    <html lang="en" className="scroll-smooth">
      <body className={inter.className}>
        <SessionWrapper>
          <UserProvider>
            <Navbar />
            <div className="min-h-[80vh] text-white inset-0 -z-10 items-center overflow-hidden justify-center bg-[#000000] bg-[radial-gradient(#ffffff33_1px,#00091d_1px)] bg-size-[20px_20px]">
              {children}
            </div>
            <Footer />
          </UserProvider>
