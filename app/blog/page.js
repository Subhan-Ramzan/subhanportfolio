...
const Blog = () => {
  return (
    <Protect>
      <div className="text-black bg-gray-50 dark:bg-gray-900 min-h-screen">
              ...
              >
                <Link href={`/blogpost/${blog.slug}`}>
                  ...
                  <Image
                    ...
                    // style={{ width: "auto", height: "auto" }} // For responsive styling
                  ...
                  <div className="p-6">
                    ...
                    <button
                      ...
                      className="text-indigo-600 dark:text-indigo-400 font-medium hover:underline hover:cursor-pointer"
                    >
                      Read More →
                    </button>
                  </div>
