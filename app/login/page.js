...
const Login = () => {
  ...
  return (
    <Protect>
      <Head>
        <title>Login | Subhan Website Portfolio</title>
        <meta
          name="description"
        ...
        />
        <meta property="og:url" content="http://subhanwebsite.vercel.app" />
        <meta property="og:type" content="website" />
      </Head>
      <div className="text-white min-h-[80vh] flex flex-col justify-center items-center px-5 py-4 bg-linear-radial from-black via-black to-[#63e]">
          ...
          <div className="flex flex-col gap-3 w-full md:w-auto">
            ...
            >
              <Image
                ...
                className="h-5 w-5 mr-2" // Add margin to right for spacing
              />
            ...
            <button
              ...
              className="bg-linear-to-r from-purple-500 to-blue-500 hover:from-purple-700 hover:to-blue-700 text-white font-bold rounded-lg inline-flex h-10 w-full md:w-64 items-center justify-center gap-2 p-3 text-sm hover:bg-blue-300 outline-none focus:ring-2 focus:ring-black focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-60"
            >
              <Image
